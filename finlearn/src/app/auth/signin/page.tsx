        ...
        <div className="glass rounded-3xl p-8 shadow-2xl">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={loading}
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3 font-medium text-white transition-all hover:bg-white/10 hover:border-white/20 active:scale-[0.98] disabled:opacity-50"
            >
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#0f172a] px-4 py-1 rounded-full border border-white/10 text-text-muted">Or secure guest access</span>
              </div>
            </div>
            ...
            <button
              onClick={async () => {
                setLoading(true);
                await signIn("credentials", { email: "guest@example.com", callbackUrl: "/" });
                setLoading(false);
              }}
              disabled={loading}
          ...
          <div className="mt-8 text-center text-sm text-text-muted">
            <p>One-click access enabled for immediate learning.</p>
          </div>
        </div>
      </div>
    </div>
